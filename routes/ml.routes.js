...
// Predecir agotamiento de un SKU en un cedis
// POST /api/ml/stock-predict
// Body: { cedis_id, sku }
...
// Predecir agotamiento de TODOS los productos de un cedis
// POST /api/ml/stock-predict/cedis
// Body: { cedis_id }
...
// Calcular patrón de reorden para un cliente + SKU
// POST /api/ml/reorder-pattern
// Body: { customer_id, sku, sku_name? }
...
// Recalcular todos los patrones de un cliente
// POST /api/ml/reorder-pattern/customer
// Body: { customer_id }
...
// Sugerir sustitutos personalizados
// POST /api/ml/substitution/suggest
// Body: { customer_id, original_sku, cedis_id, order_id? }
